package com.air.logincomponent.ui.widget;
 ...
 *         </p>
 *         <p>
 *         1、更新当前进度值：{@link #setProgress(float)} 此方法可在,UI、非UI线程中使用.
 *         2、进度的默认最大值为360F
 *         后续更新更多功能
 *         </p>
 *         <p>
 *         <code>
 *         <com......CircleProgressTextView
 *         android:layout_width="wrap_content"
 *         android:layout_height="wrap_content"
 *         app:cp_progress="30"
 *         android:text="跳过"
 *         android:padding="10dp"
 *         app:cp_circle_paint_width="5dp"
 *         app:cp_progress_paint_width="5dp" />
 *         </code>
 *         </p>
 */
...
public class CircleProgressTextView extends AppCompatTextView {
    ...
    public CircleProgressTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mSweepAngle = typedArray.getFloat(R.styleable.CircleProgressTextView_cp_progress, 0f);
        mCirclePaintDefaultWidth = typedArray.getDimensionPixelSize(R.styleable.CircleProgressTextView_cp_circle_paint_width, 0);
        mProgressPaintDefaultWidth = typedArray.getDimensionPixelSize(R.styleable.CircleProgressTextView_cp_progress_paint_width, 0);
        //recycle resource.
        typedArray.recycle();
